            ...
            <div className='top__half--container__day'>
                <div className='top__half__clock--container__day'>
                    <div className='top__half__clock__container__day__greeting--container'>
                        ...
                        <p className='top__half__clock__container__day__greeting--text'>GOOD MORNING, IT'S CURRENTLY</p>
                    </div>
                    <div className='top__half__clock__container__day__time--container'>
                        <p className='top__half__clock__container__day--currentTime'>11:37</p>
                        <p className='top__half__clock__container__day--timeZone'>BST</p>
                    </div>
                     <div className='top__half__clock__less__day--container'>
                    <p className='top__half__clock__less__container__day--location'>IN LONDON, UK</p>
                    <div className='top__half__clock__less__container__day--dropdown'>
                        <p className='top__half__clock__less__container__day--text'>LESS</p>
                        <button className='top__half__clock__less__container__day--button' onClick={() => props.onClick()}><IoIosArrowDropupCircle/></button>
                    </div>
                </div>
                </div>
